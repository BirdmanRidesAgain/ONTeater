...
#
# Optional:
#   CONTAINER_IMAGE=ghcr.io/birdmanridesagain/onteater:1.0.0-amd64 ./scripts/smoke_test_docker.sh
...
ND_ASM="${ND_ASM:-}"
FINAL_ASM="${FINAL_ASM:-}"
CONTAINER_IMAGE="${CONTAINER_IMAGE:-ghcr.io/birdmanridesagain/onteater:1.0.0-amd64}"
